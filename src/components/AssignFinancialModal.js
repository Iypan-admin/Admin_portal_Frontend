...
const AssignFinancialModal = ({ onClose, onAssign, financialId }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    setSubmitting(true);
    try {
      await onAssign(financialId, selectedManager);
    } finally {
      setSubmitting(false);
    }
  };
      ...
      <div className="bg-white rounded-xl shadow-lg w-full max-w-md">
        ...
        <div className="px-6 py-4 border-b border-gray-200">
          <div className="flex justify-between items-center">
            <h2 className="text-xl font-semibold text-gray-800">Assign Financial Partner to Manager</h2>
            <button
              onClick={onClose}
        ...
        <form onSubmit={handleSubmit}>
          <div className="px-6 py-4">
            ...
            <p className="text-gray-700 mb-4">
              Select a manager to assign this financial partner to:
            </p>
          ...
          <div className="px-6 py-4 border-t border-gray-200 flex justify-end space-x-3">
            ...
            <button
              ...
              disabled={loading || managers.length === 0 || !selectedManager || submitting}
            >
...
export default AssignFinancialModal;